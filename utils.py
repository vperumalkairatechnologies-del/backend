...
Key additions:
  - require_auth decorator  (was duplicated in every api/*.py file)
  - require_admin decorator (re-verifies role from DB on every request)
  - json_resp / json_error  (unchanged)
"""
